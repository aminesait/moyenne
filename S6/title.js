...
const modules = [
    { nom: "asservissement et regulation", coefficient: 3, image: "img/lap.png", test: true },
    { nom: "capteurs et instrumentation", coefficient: 2, image: "img/int.png", test: true },
    { nom: "electronique de puissance", coefficient: 2, image: "img/pro.png", test: true },
    { nom: "electronique des impulsions", coefficient: 2, image: "img/vom.png", test: true },
    { nom: "projet de fin de cycle", coefficient: 2, image: "img/mic.png", test: true } ,
    { nom: "dispositif opto élèctronique" ,coefficient: 2, image: "img/gol.png", test: false },  
    { nom: "tp asservissment", coefficient: 1, image: "img/chi.png", test: false } ,
    { nom: "tp capteurs", coefficient: 1, image: "img/volt.png", test: false } ,
    { nom: "tp electronique de puissance et impulssion ", coefficient: 1, image: "img/sns.png", test: false }, 
